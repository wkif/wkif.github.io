...
$(function () {
  var bookmark = {
    data: [{
      ...
      {
        name: '新生自助服务网',
        link: 'http://yxzz.xtu.edu.cn/yxxt/web/xsLogin/login.zf',
        box_shadow: '#0078D8',
        icon: 'img/xtulogo.png',
      },
      {
      ...
      {
        name: '实验室安全学习考试系统',
        link: 'http://sys.xtu.edu.cn/aqzr/index.aspx',
        box_shadow: '#0078D8',
        icon: 'img/xtulogo.png',
      },
      ...
      {
        name: '湘潭大学网银自助缴费平台        ',
        link: 'http://cwjf.xtu.edu.cn/cwjf/#OnlinePay',
        box_shadow: '#0078D8',
        icon: 'img/xtulogo.png',
      }, {
        name: '豆瓣',
      ...
      },
      {
        ...
        box_shadow: '#37bf4c',
        icon: 'https://cdn.jsdelivr.net/gh/wkif/ImageHosting@master/kif_img/20210905133301.png',
      }, {
        name: '虎扑',
...
$(function () {
  ...
  $('#night').click(function () {
    if (rgb2hex($('#main').css('background-color')) == '#ffffff') {
      ...
      document.getElementById("main").style.backgroundImage = 'url(https://api.paugram.com/bing)';
...
$('#bg').click(function () {
  width < 768 ? ($('#main').css('background-image') == 'none' ? ($('#main').css('background-image', 'url(img/bg-xs.jpg)')) : ($('#main').css('background-image', 'none'))) : $('#main').css('background-image') == 'none' ? ($('#main').css('background-image', 'url(https://api.paugram.com/bing)')) : ($('#main').css('background-image', 'none'));
